...
//        $data = $options['data'];
        ...
        $builder
            ...
            ->add('p_weight', NumberType::class, ['required' => false, 'label' => 'Weight', 'empty_data' => '0'])
            ->add('p_weight_bruto', NumberType::class, ['required' => false, 'label' => 'Weight gross (bruto)', 'empty_data' => '0'])
            ->add('p_length', NumberType::class, ['required' => false, 'label' => 'Length', 'empty_data' => '0'])
            ->add('p_height', NumberType::class, ['required' => false, 'label' => 'Height', 'empty_data' => '0'])
            ->add('p_width', NumberType::class, ['required' => false, 'label' => 'Width', 'empty_data' => '0'])
            ->add('p_delivery_time', TextType::class, ['required' => false, 'label' => 'Delivery time'])
            ->add('p_google_category_id', TextType::class, ['required' => false, 'label' => 'Google category id', 'empty_data' => '0'])
